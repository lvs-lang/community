...
import Phone1 from './assets/screenshots/contact-phone.png';
...
export default {
  ...
  welcome: {
    title: 'Join your own exclusive community',
    text: `Get together with like-minded people. Meet regulary. Form meaningful connections. Maximum Five people per group where everyone has a voice.`,
  },
  footer: {
    section1: {
    ...
    features: [
      {
        ...
        title: 'Have many interests',
        text:
          'You can join as many groups as you want - from engineering to DYI to Arts',
      },
      {
        id: 'feature2',
        IconProps: {
        ...
        title: 'Limited crowd',
        text:
          'In a small group of five, everyone has a chance to participate.',
      },
      {
        id: 'feature3',
        IconProps: {
        ...
        title: 'Meet Regulary',
        text:
          `You get the chance to talk to your community whenever you'd like. `,
      },
    ],
  },
  socialLinks: [
  ...
  contact: {
    title: 'Join Community Now',
    text:
      'Sign up for exclusive early access to the app.',
